...
4. Соблюдайте ритм отступов из `UNIFICATION_GUIDE.md` и раздела «Общие требования» в UI Kit: 
...
| Детальные страницы      | Схема в `ui-kit.html` (“Детальные страницы”): `.detail-layout`, `.detail-sidebar`, `ui-kit-flow-step`. |
