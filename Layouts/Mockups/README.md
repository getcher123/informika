...
- **idea-form.html** — форма создания идеи (шаг отправки на модерацию).
- **team-requests.html** — заявка на вступление в команду (отдельная форма).
- **my-notifications.html** — лента уведомлений участника.
