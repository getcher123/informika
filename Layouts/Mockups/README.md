...
Все интерактивные блоки (табы, фильтры, карточки) подключены к `app.js`, поэтому можно сразу проверить поведение перед переносом на страницу.
...
<div class="form-group">
  ...
  <span class="form-error form-error--hidden">Это поле обязательно</span>
</div>
```
