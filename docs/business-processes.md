...
- **Отображение на витрине:** блок «Команда» показывает текущий состав (ФИО и роли), без метрик заполненности; список заявок виден карточками со статусами (`На рассмотрении/Принята/Отклонена/Архив`), без кнопок принятия/отклонения; для автора заявки доступна только кнопка «Отозвать» в статусе «На рассмотрении».
