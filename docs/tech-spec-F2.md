...
3. Формирование команды выполняется только в Bitrix24: координатор принимает/отклоняет заявки, закрывает обязательные слоты через задачи/чек-листы. На портале отображается только текущий состав команды и статусы заявок.
