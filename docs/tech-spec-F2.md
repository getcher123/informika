...
- Вкладка **«Мои запросы»**: табличный список запросов (Название, Статус, Дедлайн, Количество идей, Дата обновления) с фильтрами по статусу, направлению, периоду и признаку «Есть новые идеи/комментарии».
- Карточка запроса: блок деталей + таблица идей с действиями **«Одобрить»**, **«Отклонить»**, **«Отправить на доработку»**; при выборе доработки обязательно указывается причина, которая сохраняется в журнале и отправляется автору уведомлением.
- Вкладка **«Портфель одобренных идей»**: карточки разбиваются по стадиям «Одобрена», «Готово к ПК», «Готово к НТК», отображаются ключевые показатели, риски, состав команды.
- Карточка одобренной идеи:
  - раздел «Обзор» + кнопки **«Перейти к задачам»**, **«Перейти к документам»**, **«Перейти к отчётам»**, **«Перейти к административной доске»**; вкладки для задач/документов/отчётов не используются.
- Журнал событий в кабинете фиксирует решения по идеям (одобрено, отклонено, отправлено на доработку с указанной причиной).
- Доступен поиск по направлениям, подразделениям, датам обновления и статусам стадий.
