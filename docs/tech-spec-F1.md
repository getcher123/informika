...
- Карточка идеи (страница):
  - Шапка: направление, статус-чип («Черновик»/«На модерации»/«На рассмотрении»/«На доработке»/«Принята»/«Отклонена»), заголовок, привязка к запросу (ссылка), автор (ФИО).
...
- Личный кабинет (общий для участника и стейкхолдера):
  ...
  - Вкладка «Мои заявки»:
    ...
    - Фильтры-чипсы (Идеи): Все / Черновики / На модерации / На доработке / На рассмотрении / Принятые / Отклонённые + «Сбросить».
