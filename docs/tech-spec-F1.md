...
## **13. Итоги Ф1 и состояние личных кабинетов**
- Все требования и критерии приёмки Ф1 выполнены и проверены на стенде.
- Кастомный личный кабинет участника реализован как отдельное Bitrix‑приложение на дополнительном сайте (`innovations.local`), интегрированное с основной базой данных.
- Личные кабинеты стейкхолдера и модератора в Ф1 предоставляются средствами стандартного CRM Bitrix; для стейкхолдера запланирована кастомизация во Ф2, а для модератора отдельный кастомный интерфейс не предусматривается.
