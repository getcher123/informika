...
---
Связанные документы: [Краткое ТЗ (обзор)](../overview.md), [ТЗ Фазы 2](tech-spec-F2.md), [ТЗ Фазы 3](tech-spec-F3.md), [Описание интерфейсов](../../ui/interface-elements.md), [Таблица статусов](../../ui/statuses-table.md).
